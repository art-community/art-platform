...
import ru.art.platform.api.model.request.AgentModuleStopRequest;

@IgnoreGeneration
public interface AgentModuleStopRequestMapper {
	...
	ValueToModelMapper<AgentModuleStopRequest, Entity> toAgentModuleStopRequest = entity -> isNotEmpty(entity) ? AgentModuleStopRequest.builder()
	...
	ValueFromModelMapper<AgentModuleStopRequest, Entity> fromAgentModuleStopRequest = model -> isNotEmpty(model) ? Entity.entityBuilder()
