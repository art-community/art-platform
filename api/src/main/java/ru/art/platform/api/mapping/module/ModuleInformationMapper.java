...
public interface ModuleInformationMapper {
	String id = "id";
	...
	ValueToModelMapper<ModuleInformation, Entity> toModuleInformation = entity -> isNotEmpty(entity) ? ModuleInformation.builder()
	...
	ValueFromModelMapper<ModuleInformation, Entity> fromModuleInformation = model -> isNotEmpty(model) ? Entity.entityBuilder()
