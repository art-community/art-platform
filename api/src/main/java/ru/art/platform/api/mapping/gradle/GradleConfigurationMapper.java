...
public interface GradleConfigurationMapper {
	...
	ValueToModelMapper<GradleAssemblyConfiguration, Entity> toGradleConfiguration = entity -> isNotEmpty(entity) ? GradleAssemblyConfiguration.builder()
	...
	ValueFromModelMapper<GradleAssemblyConfiguration, Entity> fromGradleConfiguration = model -> isNotEmpty(model) ? Entity.entityBuilder()
